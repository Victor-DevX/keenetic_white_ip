...
- Проверка IP на принадлежность к диапазонам:
  ...
  - `100.64.0.0/10`
  - `172.16.0.0/12`
- Автоматический реконнект PPPoE сессии при наличии ip из диапазона выше только после загрузки служб роутера.
...
- PPPoE-подключение провайдера (если стоит провайдерский роутер, то нужно его перевести в bridge и создавать подключение непосредственно на Кинетике)
